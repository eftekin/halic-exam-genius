...
if language_on:
    st.write(
        "As the exams have concluded, we are no longer providing the midterm exam dates. We hope you had a successful exam period and look forward to seeing you here again during the upcoming exam weeks."
    )
    ...
    st.write(
        "Sınavlarınızın sona erdiği bu dönemde, ara sınav tarihlerini artık sağlamıyoruz. Başarılı bir sınav dönemi geçirdiğinizi umar, önümüzdeki sınav haftalarında tekrar burada görüşmeyi dileriz."
    )
